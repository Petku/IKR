...
for file, expected, returned in zip(test_filenames, test_persons_classes, test_classes_Predictions):
    print("[{0}, {1}, log-likelihoods-should-be-here-array]".format(file,returned))
